...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // fill array for timeTable with formatted hours string and "pricePerHour" array with hours
        for (int i = 0; i < 24; i++) {
        ...
        do {
            ...
            if (choice.equals("2")) {
                ...
                int total = 0;
                int minPrice = pricePerHour[0][0];
                int positionMin = 0;
                int maxPrice = pricePerHour[0][0];
                int positionMax = 0;
